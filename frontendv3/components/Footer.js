      ...
      <footer aria-label="Site Footer" class="bg-white">
        <div class="mx-auto max-w-screen-xl px-4 pt-16 pb-6 sm:px-6 lg:px-8 lg:pt-24">
          <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
            <div>
              <div class="flex justify-center text-primary_color sm:justify-start">
                <svg
                  class="h-8"
                  viewBox="0 0 118 24"
                  fill="none"
              ...
              <p class="mx-auto mt-6 max-w-md text-center leading-relaxed text-gray-500 sm:mx-0 sm:max-w-xs sm:text-left">
              ...
              <ul class="mt-8 flex justify-center gap-6 sm:justify-start md:gap-8">
                <li>
                  <a
                    ...
                    rel="noreferrer"
                    target="_blank"
                    class="text-primary_color transition hover:text-primary_color/75"
                  >
                    ...
                    <li>
                      ...
                      >
                        ...
                        <span class="relative -mr-2 flex h-2 w-2">
                          <span class="absolute inline-flex h-full w-full animate-ping rounded-full bg-primary_color opacity-75"></span>
                          <span class="relative inline-flex h-2 w-2 rounded-full bg-primary_color"></span>
                        </span>
                      </a>
                    </li>
                  </ul>
          ...
          <div class="mt-12 border-t border-gray-100 pt-6">
            <div class="text-center sm:flex sm:justify-between sm:text-left">
              <p class="text-sm text-gray-500">
                ...
                <a
                  class="inline-block text-primary_color underline transition hover:text-primary_color/75"
                  href="/"
                >
                  Terms & Conditions
                </a>
